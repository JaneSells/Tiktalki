...
const app = express();
const PORT = process.env.PORT || 3000; // Vercel will provide PORT, otherwise defaults to 3000
...
app.post('/convert-mp3', async (req, res) => {
    ...
    try {
        ...
        const fetchAPI = await fetch(`https://youtube-mp36.p.rapidapi.com/dl?id=${uniqueID}`, {
            method: "GET",
            headers: {
                "X-RapidAPI-Key": process.env.API_KEY, // Ensure this variable is set in Vercel
